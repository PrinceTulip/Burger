...
function initMap(){map=new google.maps.Map(document.getElementById("map"),{zoom:17,center:new google.maps.LatLng(59.896226,30.424275),mapTypeId:"roadmap"});var e={logo:{icon:{url:"../img/symbol/sprite.svg#map-marker",size:new google.maps.Size(50,60),scaledsize:new google.maps.Size(50,60)}}};[{position:new google.maps.LatLng(59.896248,30.424275),type:"logo"},{position:new google.maps.LatLng(59.895356,30.423146),type:"logo"},{position:new google.maps.LatLng(59.894529,30.417746),type:"logo"},{position:new google.maps.LatLng(59.89844,30.428543),type:"logo"}].forEach(function(o){new google.maps.Marker({position:o.position,icon:e[o.type].icon,map:map})})}var btn=document.querySelector(".btn-burger"),close=document.querySelector(".btn-close"),modal=document.querySelector(".burger-modal");btn.addEventListener("click",function(e){e.preventDefault(),modal.classList.add("modal-show")}),close.addEventListener("click",function(e){e.preventDefault(),modal.classList.remove("modal-show")}),$(function(){$(".team__link").on("click",function(e){e.preventDefault();var o=$(e.currentTarget).closest(".team__item"),t=$(".team-row");o.toggleClass("team__item--open").siblings().removeClass("team__item--open"),t.outerHeight()})});var map;
