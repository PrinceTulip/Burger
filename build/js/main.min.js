...
<<<<<<< HEAD
var btn=document.querySelector(".btn-burger"),close=document.querySelector(".btn-close"),modal=document.querySelector(".burger-modal");btn.addEventListener("click",function(e){e.preventDefault(),modal.classList.add("modal-show")}),close.addEventListener("click",function(e){e.preventDefault(),modal.classList.remove("modal-show")}),$(document).ready(function(){$(".slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:3})});
=======
var btn=document.querySelector(".btn-burger"),close=document.querySelector(".btn-close"),modal=document.querySelector(".burger-modal");btn.addEventListener("click",function(e){e.preventDefault(),modal.classList.add("modal-show")}),close.addEventListener("click",function(e){e.preventDefault(),modal.classList.remove("modal-show")}),$(function(){$(".team__link").on("click",function(e){e.preventDefault();var t=$(e.currentTarget).closest(".team__item"),o=$(".team-row");t.toggleClass("team__item--open").siblings().removeClass("team__item--open"),o.outerHeight()})});
>>>>>>> plugin
